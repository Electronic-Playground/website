...
const TeamCard = ({ member }) => (
    <div className=" team-box cardTransition flex w-[390px] flex-col items-start rounded-xl border-2 border-primaryStar bg-slate-50 px-6 py-8 hover:-translate-y-3 hover:rounded-xl hover:shadow-2xl h-[405px]">
        ...
        <div className="mt-12">
            <h3 className="font-akzidenz mt-2 text-[26px] font-extrabold">
                {member.name}
            </h3>
