...
const Navbar = () => (
    <nav id="navbar" className="relative flex flex-col md:flex-row justify-between bg-bg-main-color px-2 md:px-16 pt-2 md:pt-8">
        <div>
            <img
        ...
        <hr className="h-[1px] w-[100%] m-auto border-white md:hidden my-4"/>
    </nav>
);
